...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/bin',
 'BINLIBDEST': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8',
 'BLDLIBRARY': '-L. -lpython3.8',
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup '
              '-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  '
              '-arch arm64 '
              '-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  '
              '-arch arm64',
 'BUILDEXE': '.exe',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           ...
           '-I/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include  '
           '-arch arm64 '
           '-I/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include  '
           '-arch arm64',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include  '
                     '-arch arm64',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            '-Wno-unused-parameter '
                            '-Wno-missing-field-initializers',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  '
                      '-arch arm64',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv' "
                "'CFLAGS=-I/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include  "
                "-arch arm64' "
                "'LDFLAGS=-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  "
                "-arch arm64' "
                "'PKG_CONFIG_PATH=/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include',
 'CONFINCLUDEPY': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include/python3.8',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18/coverage.info',
 'COVERAGE_REPORT': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv '
             '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib '
             '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8 '
             '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8/lib-dynload',
 'DESTLIB': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8',
 'DESTPATH': '',
 'DESTSHARED': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include '
                   '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include '
                   '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include/python3.8 '
                   '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include/python3.8',
 'INCLUDEDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include',
 'INCLUDEPY': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/include/python3.8',
 ...
 'LDVERSION': '3.8',
 'LIBC': '',
 'LIBDEST': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8',
 'LIBDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/pkgconfig',
 'LIBPL': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8/config-3.8-darwin',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib/python3.8',
 'MACOSX_DEPLOYMENT_TARGET': '11.1',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/share/man',
 ...
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  '
               '-arch arm64 '
               '-L/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib  '
               '-arch arm64',
 'Py_DEBUG': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18',
 'SCRIPTDIR': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18 '
 ...
 'abs_builddir': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18',
 'abs_srcdir': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/../work/Python-3.8.18',
 'datarootdir': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv/share',
 'exec_prefix': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv',
 'prefix': '/Users/ravina/Whatsapp_chatAnalyzer/whatapp_venv',
 'srcdir': '.'}
